  ...
  return (
    <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
      ...
      <div style={{ width: 380, minWidth: 300 }}>
        ...
        <input className="input" style={{ width: '100%', marginBottom: 12 }} placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)} />

        <label style={{ display: 'block', marginBottom: 8 }}>Phone</label>
        <input className="input" style={{ width: '100%', marginBottom: 12 }} placeholder="Phone" value={phone} onChange={e => setPhone(e.target.value)} />
